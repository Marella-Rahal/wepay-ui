...
const StatisticPayment = (props) => {
  return (
        <div className='px-2 py-4 text-[12px] xs:text-sm rounded-lg shadow-cardShadow flex flex-col-reverse items-center md:flex-row md:space-x-3 md:justify-between text-center md:text-end md:h-40'>
